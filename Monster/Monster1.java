...
public class Monster1 extends Monster { // 이름 가명칭-이름을 제대로 지어줍시다! 몬스터1이라니! 어떻게 알아먹나요!
	...
	public void attack() { // 공격 모션
		bullet = new BulletOfMonster("bullet1.gif",5,new Point(getPoint().x,getPoint().y-40), room.player.getPoint(), room);
		room.bulletList.add((Bullet) bullet);  // 기술명 넘기기
		room.add(bullet);
	}
}
