...
public class StageSel extends JFrame {
	...
	void plusInit(){
			roomCreate.addBlock(1, new Point(50, 20), new Point(1200, 50));
			roomCreate.addBlock(1, new Point(20, 0), new Point(50, 800));
			roomCreate.addBlock(1, new Point(1280-90, 0), new Point(50, 800));
			roomCreate.addBlock(1, new Point(0, 800-90), new Point(1280, 50));
	}
	...
	public Stage saveTmpStage(int selRow) {
		...
		while (it.hasNext()) {
			block = (Block) it.next();
			stage.addBlock(block.num, (int) block.x, (int) block.y, (int) block.width, (int) block.height);
		}
		it = roomCreate.monsterList.iterator();
		while (it.hasNext()) {
			monster = (Monster) it.next();
			stage.addMonster(monster.num, (int) monster.x, (int) monster.y);
		}
		return stage;
	}
	...
	public void writeStage(LinkedList<Stage> stageList, Stage selStage, boolean remove) {
		...
		System.out.println(selStage.stageNum);
		try {
